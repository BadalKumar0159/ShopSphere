...
const PlaceOrder = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      let orderData = {                   //these three data will send to backend
        address: formData,
        items: orderItems,
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col md:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
      {/* ------------------------ Left Side ---------------------------- */}
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('cod')} className='flex items-center gap-1 border p-2 px-2 cursor-pointer'>
